...
`git clone https://github.com/darnrain/yt-playlist.git ${HOME}/tmp/yt-playlist/; sudo chmod +x ${HOME}/tmp/yt-playlist/yt-playlist-linux/install.sh; ${HOME}/tmp/yt-playlist/yt-playlist-linux/install.sh`

To uninstall copy and paste this command into the terminal:<br>

`git clone https://github.com/darnrain/yt-playlist.git ${HOME}/tmp/yt-playlist/; chmod +x ${HOME}/tmp/yt-playlist/yt-playlist-linux/uninstall.sh; ${HOME}/tmp/yt-playlist/yt-playlist-linux/uninstall.sh`
...
`git clone https://github.com/darnrain/yt-playlist.git ${HOME}/tmp/yt-playlist/; chmod +x ${HOME}/tmp/yt-playlist/yt-playlist-termux/install.sh; ${HOME}/tmp/yt-playlist/yt-playlist-termux/install.sh`

To uninstall copy and paste this command into Termux:<br>

`git clone https://github.com/darnrain/yt-playlist.git ${HOME}/tmp/yt-playlist/; chmod +x ${HOME}/tmp/yt-playlist/yt-playlist-termux/uninstall.sh; ${HOME}/tmp/yt-playlist/yt-playlist-termux/uninstall.sh`
