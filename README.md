...
When uninstalling yt-playlist the ~/.config/yt-playlist/ directory does not get deleted, so your favorites bookmarks and history are not deleted. Run this command to delete ~/.config/yt-playlist/ directory.<br>
