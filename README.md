...
yt-playlist does not login to YouTube, YTMusic, does not use Google's api, does not log your activity, is 100% anonymous. Everything such as History/favorites are stored on your local hard drive at ~/.config/yt-playlist/. The only thing that may be logged is your ip address, by YouTube.<br>
