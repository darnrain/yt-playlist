...
yt-playlist does not login to YouTube or YTMusic or Google, does not use Google's api, does not log your activity, is 100% anonymous. Everything such as History/favorites are stored on your hard drive at ~/.config/yt-playlist/. The only thing that may be logged is your ip address, by YouTube.<br>
