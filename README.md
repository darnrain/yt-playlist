...
* When watching video in the Play SD menu or the Play SD bookmarkm menu, the 720p video is not throttled.
* The Play HD menu depends on the cache to FF and RR. I had to open two yt-dlp streams one for audio and one for video and pipe both streams into mpv.
