...
yt-playlist does not login to YouTube or YTMusic or Google, does not use Google's api, does not log your activity, is 100% anonymous. Everything such as History/favorites are stored on your local hard drive at ~/.config/yt-playlist/. The only thing that may be logged is your ip address, by YouTube.<br>
...
* The Play HD menu relies on the cache to FF and RR. The max ram cache size in the Play HD menu is 500MB. The HD video is not throttled.
