...
If you are installing for the first time, start at Install brew. If on v0.18 or below, then start at Install the dependencies. To upgrade go to Automated install or Offline install.
